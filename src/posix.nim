...
when hasAioH:
  proc aio_cancel*(a1: cint, a2: ptr Taiocb): cint {.importc .}
  proc aio_error*(a1: ptr Taiocb): cint {.importc .}
  proc aio_fsync*(a1: cint, a2: ptr Taiocb): cint {.importc .}
  proc aio_read*(a1: ptr Taiocb): cint {.importc .}
  proc aio_return*(a1: ptr Taiocb): int {.importc .}
  proc aio_suspend*(a1: ptr ptr Taiocb, a2: cint, a3: ptr Timespec): cint {.
                   importc .}
  proc aio_write*(a1: ptr Taiocb): cint {.importc .}
  proc lio_listio*(a1: cint, a2: ptr ptr Taiocb, a3: cint,
               a4: ptr SigEvent): cint {.importc .}

# arpa/inet.h
proc htonl*(a1: uint32): uint32 {.importc .}
proc htons*(a1: uint16): uint16 {.importc .}
proc ntohl*(a1: uint32): uint32 {.importc .}
proc ntohs*(a1: uint16): uint16 {.importc .}

when not defined(zephyr):
  proc inet_addr*(a1: cstring): InAddrT {.importc .}
  proc inet_ntoa*(a1: InAddr): cstring {.importc .}
...
var
  in6addr_any* {.importc .}: In6Addr
  in6addr_loopback* {.importc .}: In6Addr

proc IN6ADDR_ANY_INIT* (): In6Addr {.importc .}
proc IN6ADDR_LOOPBACK_INIT* (): In6Addr {.importc .}

# dirent.h
proc closedir*(a1: ptr DIR): cint  {.importc .}
proc opendir*(a1: cstring): ptr DIR {.importc , sideEffect.}
proc readdir*(a1: ptr DIR): ptr Dirent  {.importc , sideEffect.}
proc readdir_r*(a1: ptr DIR, a2: ptr Dirent, a3: ptr ptr Dirent): cint  {.
                importc , sideEffect.}
proc rewinddir*(a1: ptr DIR)  {.importc .}
proc seekdir*(a1: ptr DIR, a2: int)  {.importc .}
proc telldir*(a1: ptr DIR): int {.importc .}

# dlfcn.h
proc dlclose*(a1: pointer): cint {.importc , sideEffect.}
proc dlerror*(): cstring {.importc , sideEffect.}
proc dlopen*(a1: cstring, a2: cint): pointer {.importc , sideEffect.}
proc dlsym*(a1: pointer, a2: cstring): pointer {.importc , sideEffect.}

proc creat*(a1: cstring, a2: Mode): cint {.importc , sideEffect.}
proc fcntl*(a1: cint | SocketHandle, a2: cint): cint {.varargs, importc , sideEffect.}
proc openImpl(a1: cstring, a2: cint): cint {.varargs, importc: "open" , sideEffect.}
...
when not defined(haiku) and not defined(openbsd):
  proc fmtmsg*(a1: int, a2: cstring, a3: cint,
              a4, a5, a6: cstring): cint {.importc .}

proc fnmatch*(a1, a2: cstring, a3: cint): cint {.importc .}
proc ftw*(a1: cstring,
         a2: proc (x1: cstring, x2: ptr Stat, x3: cint): cint {.noconv.},
         a3: cint): cint {.importc .}
when not (defined(linux) and defined(amd64)) and not defined(nintendoswitch):
  proc nftw*(a1: cstring,
            ...
            a3: cint,
            a4: cint): cint {.importc .}

proc glob*(a1: cstring, a2: cint,
          a3: proc (x1: cstring, x2: cint): cint {.noconv.},
          a4: ptr Glob): cint {.importc , sideEffect.}
  ## Filename globbing. Use `os.walkPattern() <os.html#glob_1>`_ and similar.

proc globfree*(a1: ptr Glob) {.importc .}

proc getgrgid*(a1: Gid): ptr Group {.importc .}
proc getgrnam*(a1: cstring): ptr Group {.importc .}
proc getgrgid_r*(a1: Gid, a2: ptr Group, a3: cstring, a4: int,
                 a5: ptr ptr Group): cint {.importc .}
proc getgrnam_r*(a1: cstring, a2: ptr Group, a3: cstring,
                  a4: int, a5: ptr ptr Group): cint {.
                 importc .}
proc getgrent*(): ptr Group {.importc .}
proc endgrent*() {.importc .}
proc setgrent*() {.importc .}


proc iconv_open*(a1, a2: cstring): Iconv {.importc .}
proc iconv*(a1: Iconv, a2: var cstring, a3: var int, a4: var cstring,
            a5: var int): int {.importc .}
proc iconv_close*(a1: Iconv): cint {.importc .}

proc nl_langinfo*(a1: Nl_item): cstring {.importc .}

proc basename*(a1: cstring): cstring {.importc .}
proc dirname*(a1: cstring): cstring {.importc .}

proc localeconv*(): ptr Lconv {.importc .}
...
when not defined(nintendoswitch):
  proc mq_close*(a1: Mqd): cint {.importc .}
  ...
  proc mq_timedreceive*(a1: Mqd, a2: cstring, a3: int, a4: int,
                        a5: ptr Timespec): int {.importc .}
  proc mq_timedsend*(a1: Mqd, a2: cstring, a3: int, a4: int,
                     a5: ptr Timespec): cint {.importc .}
  proc mq_unlink*(a1: cstring): cint {.importc .}


proc getpwnam*(a1: cstring): ptr Passwd {.importc .}
proc getpwuid*(a1: Uid): ptr Passwd {.importc .}
proc getpwnam_r*(a1: cstring, a2: ptr Passwd, a3: cstring, a4: int,
                 a5: ptr ptr Passwd): cint {.importc .}
proc getpwuid_r*(a1: Uid, a2: ptr Passwd, a3: cstring,
      a4: int, a5: ptr ptr Passwd): cint {.importc .}
proc endpwent*() {.importc .}
proc getpwent*(): ptr Passwd {.importc .}
proc setpwent*() {.importc .}

proc uname*(a1: var Utsname): cint {.importc .}
...
proc pthread_attr_getinheritsched*(a1: ptr Pthread_attr,
          a2: var cint): cint {.importc .}
proc pthread_attr_getschedparam*(a1: ptr Pthread_attr,
          a2: ptr Sched_param): cint {.importc .}
...
proc pthread_cancel*(a1: Pthread): cint {.importc .}
proc pthread_cleanup_push*(a1: proc (x: pointer) {.noconv.}, a2: pointer) {.
  importc .}
proc pthread_cleanup_pop*(a1: cint) {.importc .}
...
proc pthread_create*(a1: ptr Pthread, a2: ptr Pthread_attr,
          a3: proc (x: pointer): pointer {.noconv.}, a4: pointer): cint {.importc .}
proc pthread_detach*(a1: Pthread): cint {.importc .}
proc pthread_equal*(a1, a2: Pthread): cint {.importc .}
proc pthread_exit*(a1: pointer) {.importc .}
proc pthread_getconcurrency*(): cint {.importc .}
proc pthread_getcpuclockid*(a1: Pthread, a2: var ClockId): cint {.importc .}
proc pthread_getschedparam*(a1: Pthread,  a2: var cint,
          a3: ptr Sched_param): cint {.importc .}
proc pthread_getspecific*(a1: Pthread_key): pointer {.importc .}
proc pthread_join*(a1: Pthread, a2: ptr pointer): cint {.importc .}
proc pthread_key_create*(a1: ptr Pthread_key, a2: proc (x: pointer) {.noconv.}): cint {.importc .}
proc pthread_key_delete*(a1: Pthread_key): cint {.importc .}
...
proc pthread_mutex_init*(a1: ptr Pthread_mutex,
          a2: ptr Pthread_mutexattr): cint {.importc .}
...
proc pthread_mutexattr_getprioceiling*(
          a1: ptr Pthread_mutexattr, a2: var cint): cint {.importc .}
...
proc pthread_mutexattr_setprioceiling*(a1: ptr Pthread_mutexattr, a2: cint): cint {.importc .}
proc pthread_mutexattr_setprotocol*(a1: ptr Pthread_mutexattr, a2: cint): cint {.importc .}
...
proc pthread_rwlock_init*(a1: ptr Pthread_rwlock,
          a2: ptr Pthread_rwlockattr): cint {.importc .}
...
proc pthread_rwlockattr_getpshared*(
          a1: ptr Pthread_rwlockattr, a2: var cint): cint {.importc .}
proc pthread_rwlockattr_init*(a1: ptr Pthread_rwlockattr): cint {.importc .}
proc pthread_rwlockattr_setpshared*(a1: ptr Pthread_rwlockattr, a2: cint): cint {.importc .}

proc pthread_self*(): Pthread {.importc .}
proc pthread_setcancelstate*(a1: cint, a2: var cint): cint {.importc .}
proc pthread_setcanceltype*(a1: cint, a2: var cint): cint {.importc .}
proc pthread_setconcurrency*(a1: cint): cint {.importc .}
...
proc pthread_spin_unlock*(a1: ptr Pthread_spinlock): cint {.
  importc .}
proc pthread_testcancel*() {.importc .}


proc exitnow*(code: int) {.importc: "_exit"}
proc access*(a1: cstring, a2: cint): cint {.importc}
proc alarm*(a1: cint): cint {.importc}
proc chdir*(a1: cstring): cint {.importc}
proc chown*(a1: cstring, a2: Uid, a3: Gid): cint {.importc}
proc close*(a1: cint | SocketHandle): cint {.importc}
proc confstr*(a1: cint, a2: cstring, a3: int): int {.importc}
proc crypt*(a1, a2: cstring): cstring {.importc}
proc ctermid*(a1: cstring): cstring {.importc}
proc dup*(a1: cint): cint {.importc}
proc dup2*(a1, a2: cint): cint {.importc}
proc encrypt*(a1: array[0..63, char], a2: cint) {.importc}

proc execl*(a1, a2: cstring): cint {.varargs, importc sideEffect.}
proc execle*(a1, a2: cstring): cint {.varargs, importc sideEffect.}
proc execlp*(a1, a2: cstring): cint {.varargs, importc sideEffect.}
proc execv*(a1: cstring, a2: cstringArray): cint {.importc sideEffect.}
proc execve*(a1: cstring, a2, a3: cstringArray): cint {.
  importc sideEffect.}
proc execvp*(a1: cstring, a2: cstringArray): cint {.importc sideEffect.}
proc execvpe*(a1: cstring, a2: cstringArray, a3: cstringArray): cint {.importc sideEffect.}
proc fchown*(a1: cint, a2: Uid, a3: Gid): cint {.importc sideEffect.}
proc fchdir*(a1: cint): cint {.importc sideEffect.}
proc fdatasync*(a1: cint): cint {.importc}
proc fork*(): Pid {.importc sideEffect.}
proc fpathconf*(a1, a2: cint): int {.importc}
proc fsync*(a1: cint): cint {.importc}
 ## synchronize a file's buffer cache to the storage device

proc ftruncate*(a1: cint, a2: Off): cint {.importc}
proc getcwd*(a1: cstring, a2: int): cstring {.importc sideEffect.}
proc getuid*(): Uid {.importc sideEffect.}
 ## returns the real user ID of the calling process

proc geteuid*(): Uid {.importc sideEffect.}
 ## returns the effective user ID of the calling process

proc getgid*(): Gid {.importc sideEffect.}
 ## returns the real group ID of the calling process

proc getegid*(): Gid {.importc sideEffect.}
 ## returns the effective group ID of the calling process

proc getgroups*(a1: cint, a2: ptr array[0..255, Gid]): cint {.
  importc}
proc gethostid*(): int {.importc sideEffect.}
proc gethostname*(a1: cstring, a2: int): cint {.importc sideEffect.}
proc getlogin*(): cstring {.importc sideEffect.}
proc getlogin_r*(a1: cstring, a2: int): cint {.importc sideEffect.}

proc getopt*(a1: cint, a2: cstringArray, a3: cstring): cint {.
  importc}
proc getpgid*(a1: Pid): Pid {.importc}
proc getpgrp*(): Pid {.importc}
proc getpid*(): Pid {.importc sideEffect.}
 ## returns  the process ID (PID) of the calling process

proc getppid*(): Pid {.importc sideEffect.}
 ## returns the process ID of the parent of the calling process

proc getsid*(a1: Pid): Pid {.importc sideEffect.}
 ## returns the session ID of the calling process

proc getwd*(a1: cstring): cstring {.importc}
proc isatty*(a1: cint): cint {.importc}
proc lchown*(a1: cstring, a2: Uid, a3: Gid): cint {.importc}
proc link*(a1, a2: cstring): cint {.importc}

proc lockf*(a1, a2: cint, a3: Off): cint {.importc}
proc lseek*(a1: cint, a2: Off, a3: cint): Off {.importc}
proc nice*(a1: cint): cint {.importc}
proc pathconf*(a1: cstring, a2: cint): int {.importc}

proc pause*(): cint {.importc}
proc pclose*(a: File): cint {.importc .}
proc pipe*(a: array[0..1, cint]): cint {.importc}
proc popen*(a1, a2: cstring): File {.importc .}
proc pread*(a1: cint, a2: pointer, a3: int, a4: Off): int {.
  importc}
proc pwrite*(a1: cint, a2: pointer, a3: int, a4: Off): int {.
  importc}
proc read*(a1: cint, a2: pointer, a3: int): int {.importc}
proc readlink*(a1, a2: cstring, a3: int): int {.importc}
proc ioctl*(f: FileHandle, device: uint): int {.importc: "ioctl",
      header: "<cosmopolitan.h>", varargs, tags: [WriteIOEffect].}
...
proc rmdir*(a1: cstring): cint {.importc}
proc setegid*(a1: Gid): cint {.importc}
proc seteuid*(a1: Uid): cint {.importc}
proc setgid*(a1: Gid): cint {.importc}

proc setpgid*(a1, a2: Pid): cint {.importc}
proc setpgrp*(): Pid {.importc}
proc setregid*(a1, a2: Gid): cint {.importc}
proc setreuid*(a1, a2: Uid): cint {.importc}
proc setsid*(): Pid {.importc}
proc setuid*(a1: Uid): cint {.importc}
proc sleep*(a1: cint): cint {.importc}
proc swab*(a1, a2: pointer, a3: int) {.importc}
proc symlink*(a1, a2: cstring): cint {.importc}
proc sync*() {.importc}
proc sysconf*(a1: cint): int {.importc}
proc tcgetpgrp*(a1: cint): Pid {.importc}
proc tcsetpgrp*(a1: cint, a2: Pid): cint {.importc}
proc truncate*(a1: cstring, a2: Off): cint {.importc}
proc ttyname*(a1: cint): cstring {.importc}
proc ttyname_r*(a1: cint, a2: cstring, a3: int): cint {.
  importc}
proc ualarm*(a1, a2: Useconds): Useconds {.importc}
proc unlink*(a1: cstring): cint {.importc}
proc usleep*(a1: Useconds): cint {.importc}
proc vfork*(): Pid {.importc}
proc write*(a1: cint, a2: pointer, a3: int): int {.importc}

proc sem_close*(a1: ptr Sem): cint {.importc .}
proc sem_destroy*(a1: ptr Sem): cint {.importc .}
...
proc sem_open*(a1: cstring, a2: cint): ptr Sem {.
  varargs, importc .}
proc sem_post*(a1: ptr Sem): cint {.importc .}
proc sem_timedwait*(a1: ptr Sem, a2: ptr Timespec): cint {.
  importc .}
proc sem_trywait*(a1: ptr Sem): cint {.importc .}
proc sem_unlink*(a1: cstring): cint {.importc .}
proc sem_wait*(a1: ptr Sem): cint {.importc .}

proc ftok*(a1: cstring, a2: cint): Key {.importc .}
...
proc chmod*(a1: cstring, a2: Mode): cint {.importc , sideEffect.}
when defined(osx) or defined(freebsd):
  proc lchmod*(a1: cstring, a2: Mode): cint {.importc , sideEffect.}
proc fchmod*(a1: cint, a2: Mode): cint {.importc , sideEffect.}
proc fstat*(a1: cint, a2: var Stat): cint {.importc , sideEffect.}
proc lstat*(a1: cstring, a2: var Stat): cint {.importc , sideEffect.}
proc mkdir*(a1: cstring, a2: Mode): cint {.importc , sideEffect.}
  ## Use `os.createDir() <os.html#createDir,string>`_ and similar.

proc mkfifo*(a1: cstring, a2: Mode): cint {.importc .}
proc mknod*(a1: cstring, a2: Mode, a3: Dev): cint {.
  importc .}
proc stat*(a1: cstring, a2: var Stat): cint {.importc .}
proc umask*(a1: Mode): Mode {.importc .}

proc S_ISBLK*(m: Mode): bool {.importc .}
  ## Test for a block special file.
proc S_ISCHR*(m: Mode): bool {.importc .}
  ## Test for a character special file.
proc S_ISDIR*(m: Mode): bool {.importc .}
  ## Test for a directory.
proc S_ISFIFO*(m: Mode): bool {.importc .}
  ## Test for a pipe or FIFO special file.
proc S_ISREG*(m: Mode): bool {.importc .}
  ## Test for a regular file.
proc S_ISLNK*(m: Mode): bool {.importc .}
  ## Test for a symbolic link.
proc S_ISSOCK*(m: Mode): bool {.importc .}
  ## Test for a socket.

proc S_TYPEISMQ*(buf: var Stat): bool {.importc .}
  ## Test for a message queue.
proc S_TYPEISSEM*(buf: var Stat): bool {.importc .}
  ## Test for a semaphore.
proc S_TYPEISSHM*(buf: var Stat): bool {.importc .}
  ## Test for a shared memory object.

proc S_TYPEISTMO*(buf: var Stat): bool {.importc .}
  ## Test macro for a typed memory object.

proc mlock*(a1: pointer, a2: int): cint {.importc .}
proc mlockall*(a1: cint): cint {.importc .}
...
proc munlock*(a1: pointer, a2: int): cint {.importc .}
proc munlockall*(): cint {.importc .}
proc munmap*(a1: pointer, a2: int): cint {.importc .}
proc posix_madvise*(a1: pointer, a2: int, a3: cint): cint {.
  importc .}
proc posix_mem_offset*(a1: pointer, a2: int, a3: var Off,
           a4: var int, a5: var cint): cint {.importc .}
when not (defined(linux) and defined(amd64)) and not defined(nintendoswitch) and
     not defined(haiku):
  proc posix_typed_mem_get_info*(a1: cint,
    a2: var Posix_typed_mem_info): cint {.importc .}
proc posix_typed_mem_open*(a1: cstring, a2, a3: cint): cint {.
  importc .}
proc shm_open*(a1: cstring, a2: cint, a3: Mode): cint {.
  importc .}
proc shm_unlink*(a1: cstring): cint {.importc .}

proc asctime*(a1: var Tm): cstring{.importc .}

proc asctime_r*(a1: var Tm, a2: cstring): cstring {.importc .}
proc clock*(): Clock {.importc , sideEffect.}
...
proc clock_nanosleep*(a1: ClockId, a2: cint, a3: var Timespec,
               a4: var Timespec): cint {.importc , sideEffect.}
proc clock_settime*(a1: ClockId, a2: var Timespec): cint {.
  importc , sideEffect.}

proc `==`*(a, b: Time): bool {.borrow.}
proc `-`*(a, b: Time): Time {.borrow.}
proc ctime*(a1: var Time): cstring {.importc .}
proc ctime_r*(a1: var Time, a2: cstring): cstring {.importc .}
proc difftime*(a1, a2: Time): cdouble {.importc .}
proc getdate*(a1: cstring): ptr Tm {.importc .}
proc gmtime*(a1: var Time): ptr Tm {.importc .}
proc gmtime_r*(a1: var Time, a2: var Tm): ptr Tm {.importc .}
proc localtime*(a1: var Time): ptr Tm {.importc .}
proc localtime_r*(a1: var Time, a2: var Tm): ptr Tm {.importc .}
proc mktime*(a1: var Tm): Time  {.importc .}
proc timegm*(a1: var Tm): Time  {.importc .}
proc nanosleep*(a1, a2: var Timespec): cint {.importc , sideEffect.}
proc strftime*(a1: cstring, a2: int, a3: cstring,
           a4: var Tm): int {.importc .}
proc strptime*(a1, a2: cstring, a3: var Tm): cstring {.importc .}
proc time*(a1: var Time): Time {.importc , sideEffect.}
proc timer_create*(a1: ClockId, a2: var SigEvent,
               a3: var Timer): cint {.importc .}
proc timer_delete*(a1: Timer): cint {.importc .}
proc timer_gettime*(a1: Timer, a2: var Itimerspec): cint {.
  importc .}
proc timer_getoverrun*(a1: Timer): cint {.importc .}
proc timer_settime*(a1: Timer, a2: cint, a3: var Itimerspec,
               a4: var Itimerspec): cint {.importc .}
proc tzset*() {.importc .}


proc wait*(a1: ptr cint): Pid {.importc, discardable , sideEffect.}
proc waitid*(a1: cint, a2: Id, a3: var SigInfo, a4: cint): cint {.
  importc , sideEffect.}
proc waitpid*(a1: Pid, a2: var cint, a3: cint): Pid {.
  importc , sideEffect.}

type Rusage* {.importc: "struct rusage" ,
               bycopy.} = object
...
proc bsd_signal*(a1: cint, a2: proc (x: pointer) {.noconv.}) {.
  importc .}
proc kill*(a1: Pid, a2: cint): cint {.importc , sideEffect.}
proc killpg*(a1: Pid, a2: cint): cint {.importc , sideEffect.}
proc pthread_kill*(a1: Pthread, a2: cint): cint {.importc .}
proc pthread_sigmask*(a1: cint, a2, a3: var Sigset): cint {.
  importc .}
proc `raise`*(a1: cint): cint {.importc .}
...
proc sigaddset*(a1: var Sigset, a2: cint): cint {.importc .}
proc sigaltstack*(a1, a2: var Stack): cint {.importc .}
proc sigdelset*(a1: var Sigset, a2: cint): cint {.importc .}
proc sigemptyset*(a1: var Sigset): cint {.importc .}
proc sigfillset*(a1: var Sigset): cint {.importc .}
proc sighold*(a1: cint): cint {.importc .}
proc sigignore*(a1: cint): cint {.importc .}
proc siginterrupt*(a1, a2: cint): cint {.importc .}
proc sigismember*(a1: var Sigset, a2: cint): cint {.importc .}
proc signal*(a1: cint, a2: Sighandler) {.
  importc .}
proc sigpause*(a1: cint): cint {.importc .}
proc sigpending*(a1: var Sigset): cint {.importc .}
proc sigprocmask*(a1: cint, a2, a3: var Sigset): cint {.
  importc .}
proc sigqueue*(a1: Pid, a2: cint, a3: SigVal): cint {.
  importc .}
proc sigrelse*(a1: cint): cint {.importc .}
proc sigset*(a1: int, a2: proc (x: cint) {.noconv.}) {.
  importc .}
proc sigsuspend*(a1: var Sigset): cint {.importc .}

when defined(android):
  proc syscall(arg: clong): clong {.varargs, importc: "syscall"}
  var NR_rt_sigtimedwait {.importc: "__NR_rt_sigtimedwait" .}: clong
  var NSIGMAX {.importc: "NSIG" .}: clong
...
when not defined(nintendoswitch):
  proc catclose*(a1: Nl_catd): cint {.importc .}
  proc catgets*(a1: Nl_catd, a2, a3: cint, a4: cstring): cstring {.
    importc .}
  proc catopen*(a1: cstring, a2: cint): Nl_catd {.
    importc .}

proc sched_get_priority_max*(a1: cint): cint {.importc .}
proc sched_get_priority_min*(a1: cint): cint {.importc .}
proc sched_getparam*(a1: Pid, a2: var Sched_param): cint {.
  importc .}
proc sched_getscheduler*(a1: Pid): cint {.importc .}
...
when hasSpawnH:
  proc posix_spawn*(a1: var Pid, a2: cstring,
            ...
            a5, a6: cstringArray): cint {.importc .}
  ...
  proc posix_spawn_file_actions_destroy*(
    a1: var Tposix_spawn_file_actions): cint {.importc .}
...
when not defined(nintendoswitch):
  proc getcontext*(a1: var Ucontext): cint {.importc .}
  proc makecontext*(a1: var Ucontext, a4: proc (){.noconv.}, a3: cint) {.
    varargs, importc .}
  proc setcontext*(a1: var Ucontext): cint {.importc .}
  proc swapcontext*(a1, a2: var Ucontext): cint {.importc .}
...
when defined(linux) or defined(bsd):
  proc accept4*(a1: SocketHandle, a2: ptr SockAddr, a3: ptr SockLen,
                flags: cint): SocketHandle {.importc .}
...
proc if_nametoindex*(a1: cstring): cint {.importc .}
proc if_indextoname*(a1: cint, a2: cstring): cstring {.
  importc .}
proc if_nameindex*(): ptr Tif_nameindex {.importc .}
proc if_freenameindex*(a1: ptr Tif_nameindex) {.importc .}
...
proc endhostent*() {.importc .}
proc endnetent*() {.importc .}
proc endprotoent*() {.importc .}
proc endservent*() {.importc .}
...
proc getaddrinfo*(a1, a2: cstring, a3: ptr AddrInfo,
                  a4: var ptr AddrInfo): cint {.importc .}
...
when not defined(android4):
  ...
  proc gethostbyaddr*(a1: cstring, a2: cint, a3: cint): ptr Hostent {.
                      importc .}
proc gethostbyname*(a1: cstring): ptr Hostent {.importc .}
proc gethostent*(): ptr Hostent {.importc .}

proc getnameinfo*(a1: ptr SockAddr, a2: SockLen,
                  a3: cstring, a4: SockLen, a5: cstring,
                  a6: SockLen, a7: cint): cint {.importc .}

proc getnetbyaddr*(a1: int32, a2: cint): ptr Tnetent {.importc .}
proc getnetbyname*(a1: cstring): ptr Tnetent {.importc .}
proc getnetent*(): ptr Tnetent {.importc .}

proc getprotobyname*(a1: cstring): ptr Protoent {.importc .}
proc getprotobynumber*(a1: cint): ptr Protoent {.importc .}
proc getprotoent*(): ptr Protoent {.importc .}

proc getservbyname*(a1, a2: cstring): ptr Servent {.importc .}
proc getservbyport*(a1: cint, a2: cstring): ptr Servent {.
  importc .}
proc getservent*(): ptr Servent {.importc .}

proc sethostent*(a1: cint) {.importc .}
proc setnetent*(a1: cint) {.importc .}
proc setprotoent*(a1: cint) {.importc .}
proc setservent*(a1: cint) {.importc .}
...
proc mkstemp*(tmpl: cstring): cint {.importc , sideEffect.}
...
proc mkstemps*(tmpl: cstring, suffixlen: int): cint {.importc , sideEffect.}
  ## Creates a unique temporary file.
  ##
...
proc mkdtemp*(tmpl: cstring): pointer {.importc , sideEffect.}

when defined(linux) or defined(bsd) or defined(osx):
  proc mkostemp*(tmpl: cstring, oflags: cint): cint {.importc , sideEffect.}
  proc mkostemps*(tmpl: cstring, suffixlen: cint, oflags: cint): cint {.importc , sideEffect.}

  proc posix_memalign*(memptr: pointer, alignment: csize_t, size: csize_t): cint {.importc .}

proc utimes*(path: cstring, times: ptr array[2, Timeval]): int {.
  importc: "utimes" , sideEffect.}
...
proc handle_signal(sig: cint, handler: proc (a: cint) {.noconv.}) {.importc: "signal" .}
